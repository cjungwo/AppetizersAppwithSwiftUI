...
struct AlertContext {
    ...
    static let invalidURL = AlertItem(title: Text("Invalid  Error"), message: Text("There was an issue connecting to the server. If this persists, please contact support."), dismissButton: .default(Text("OK")))
    ...
    static let invalidEmail = AlertItem(title: Text("Invalid Email"), message: Text("Please ensure your email."), dismissButton: .default(Text("OK")))
